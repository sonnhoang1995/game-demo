            ...
            for (let x = 0; x < tempArray.length; x++) {
                if (x < tempArray.length - 2) {
                    if (
                        ...
                        if (
                            tileGrid[y][x].texture.key ===
                                tileGrid[y][x + 1].texture.key &&
                            tileGrid[y][x + 1].texture.key ===
                                tileGrid[y][x + 2].texture.key
                        ) {
                            if (groups.length > 0) {
            ...
            for (let i = 0; i < tempArr.length; i++) {
                if (i < tempArr.length - 2)
                    if (
                        ...
                        if (
                            tileGrid[i][j].texture.key ===
                                tileGrid[i + 1][j].texture.key &&
                            tileGrid[i + 1][j].texture.key ===
                                tileGrid[i + 2][j].texture.key
                        ) {
                            if (groups.length > 0) {
