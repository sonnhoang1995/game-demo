import BorderImage from "../../../assets/images/blockade-clone/border.png";
import PlayerImage from "../../../assets/images/blockade-clone/player.png";
...
export class PlayScene extends Phaser.Scene {
    ...
    preload(): void {
        this.load.image("border", BorderImage);
    ...
    private rndXPos(): number {
        return (
            Phaser.Math.RND.between(1, this.horizontalFields - 1) *
            CONST.FIELD_SIZE
        );
    }
    ...
    private rndYPos(): number {
        return (
            Phaser.Math.RND.between(1, this.verticalFields - 1) *
            CONST.FIELD_SIZE
        );
    }
}
